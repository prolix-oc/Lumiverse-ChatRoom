...
function setup(ctx) {
  ...
  const fsBtn = headerBtn(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"/></svg>`, "Fullscreen");
  const collapseBtn = headerBtn(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"/></svg>`, "Collapse");
  const hideBtn = headerBtn(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`, "Hide");
  ...
  function updateCollapse() {
    if (isCollapsed) {
      ...
      if (!isFullscreen)
        widgetContainer.style.height = expandedHeight + "px";
  ...
  collapseBtn.addEventListener("click", () => {
    if (!isCollapsed)
      expandedHeight = widgetContainer.offsetHeight;
